...
1. Make an [Issue](https://github.com/sensengames/unity-sensen-components/issues/new)
...
```json
    {
        "dependencies": {
            "com.sensengames.unity-sensen-components": "https://github.com/YOUR_USER/unity-sensen-components.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at hugolnx@gmail.com.
